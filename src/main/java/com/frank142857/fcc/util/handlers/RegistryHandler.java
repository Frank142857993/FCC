...
public class RegistryHandler {
    ...
    @SubscribeEvent
    public static void onEnchRegistry(RegistryEvent.Register<Enchantment> event){
        event.getRegistry().registerAll(EnchantmentInit.REGISTER_ENCHANTMENTS.toArray(new Enchantment[0]));
    }
